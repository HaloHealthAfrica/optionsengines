...
jest.mock('../../../src/config/index.js', () => {
  ...
  const cfg = {
    ...
    marketDataProviderPriority: ['twelvedata', 'marketdata'],
    polygonApiKey: '',
    polygonBaseUrl: '',
    polygonRateLimit: 5,
...
const testConfig = (globalThis as typeof globalThis & { __e2e_test_config?: Record<string, unknown> }).__e2e_test_config!;
