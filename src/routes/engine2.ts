 ...
 * Used by E2E tests to validate provider connectivity.
 */
router.get('/v1/monitoring/provider-health', async (_req: Request, res: Response) => {
  try {
...
/**
 * GET /v1/monitoring/provider-probe?symbol=SPY
 * Probes option chain and options flow, returns source info for E2E validation.
 * Validates Unusual Whales and fallback providers.
 */
router.get('/v1/monitoring/provider-probe', async (req: Request, res: Response) => {
